...
Dpdl enables **Polyglot programming**, in a form that allows the use of embedded programming languages along with their specific runtime as it is (aka. Python, Ruby, etc... in its original form).
