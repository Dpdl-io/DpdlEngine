...
* Implement plug-in to enable the embedding of 'lua' programming language via keyword '**>>lua**'
* Implement plug-in to enable the embedding of 'go' programming language via keyword '**>>go**'
