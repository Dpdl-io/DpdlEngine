# File: mjs/dpdlMicroJsExample.h
#
# Example:
# Dpdl code that makes use of an 'embedded code section' in javascript (micro) to render a Mandelbrot Fractal
#
# This code can be executed with as little as 15 Kb of RAM
#
# Author: AC
# e-mail: ac@dpdl.io
#
...
console.log("dpdlArgs: " + args);

mandelbrot(-0.75, 0.0, 2.0, 80, 25, 50);

/* we can call also the functions of the included js code */
...
println("dpdl embedded mjs terminated with exit code: " + exit_code)
