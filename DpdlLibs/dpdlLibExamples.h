...
#@TEST13
println("TEST 13 #######################################")
# new(..) & getObj(..) methods to load dynamically java library classes & objects
...
object date_format = new("SimpleDateFormat", "dd/MM/yy")
object date_ = date_format.parse(date_str)
object date_format_dest = new("SimpleDateFormat", "MM-dd-yyyy hh:mm:ss")
...
object str_tok = new("StringTokenizer", myStr)
